...
{
    return '<iframe width="'.$width.'" height="'.$height.'" src="https://www.youtube.com/embed/'.substr($source, strpos($source, "=") + 1).'" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
}
